        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <h1 class="text-white">I'M Srikanth COLLATY</h1>
              <span class="text-grey">IT Engineer</span><br />
          ...
          <v-col cols="5">
            <div style="position: relative; z-index: 9999" class="mt-16" >
              <v-img src="IMG1.jpg" contain max-height="300" class="rounded-image"></v-img>
            </div>
          </v-col>
        </v-row>
      </div>
        ...
        <div>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              ...
              <h4 class="mt-n4">I Am an IT Engineer and Developer</h4>
              <p class="text-grey">
            ...
            <v-col cols="12">
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">Full-Stack Engineer</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  As a Full-Stack Engineer, 
                  <br/>I engage in diverse projects,
                  <br />leveraging a spectrum of 
                  <br/>technologies to deliver 
                  <br/>comprehensive and innovative solutions.
                </p>
              </div>
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">SAP Software Engineer</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  As an SAP Software Engineer, 
                  <br/>I specialize in designing,
                  <br/>implementing, and optimizing 
                  <br/>SAP solutions to streamline
                  <br />business processes and enhance organizational efficiency.
                </p>
              </div>
              <div class="child">
                <v-btn
                  ...
                  class="text-white"
                ></v-btn>
                <h3 class="ml-3 mt-4">cloud Engineer</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  As a Cloud Engineer,I architect and deploy scalable,
                  <br/> resilient, and secure cloud solutions,
                  <br/> utilizing cutting-edge technologies 
                  <br/>to optimize infrastructure and 
                  <br/>drive digital transformation for businesses.
                </p>
              </div>
            </v-col>
          </v-row>
